package com.seek.food.employee.Scheduled;
...
public class OldFileClearScheduled {
    ...
    @Autowired
    public OldFileClearScheduled(StringRedisTemplate stringRedisTemplate, EmployeeRedisStreamConfig employeeRedisStreamConfig) {
