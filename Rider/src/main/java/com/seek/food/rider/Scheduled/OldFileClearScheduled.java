package com.seek.food.rider.Scheduled;
...
public class OldFileClearScheduled {
    ...
    @Autowired
    public OldFileClearScheduled(StringRedisTemplate stringRedisTemplate, RiderRedisStreamConfig riderRedisStreamConfig) {
