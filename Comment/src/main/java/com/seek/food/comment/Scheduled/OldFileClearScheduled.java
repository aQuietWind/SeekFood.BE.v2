package com.seek.food.comment.Scheduled;
...
public class OldFileClearScheduled {
    ...
    @Autowired
    public OldFileClearScheduled(StringRedisTemplate stringRedisTemplate, CommentRedisStreamConfig commentRedisStreamConfig) {
