package com.seek.food.admin.Scheduled;
...
public class OldFileClearScheduled {
    ...
    @Autowired
    public OldFileClearScheduled(StringRedisTemplate stringRedisTemplate, AdminRedisStreamConfig adminRedisStreamConfig) {
